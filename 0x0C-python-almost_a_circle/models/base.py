...
Contains provate class __nb_objects, and class constructor __init__
Returns JSON string representaton of the list dictionaries
...
class Base():
    ...
    Static Methods:
        to_json_string(list_dictionaries)  from _json_string(json_string)
    Class methods:
    ...
    def __init__(self, id=None):
        """Initialize id, increment class attributes if no id and set as id"""
        if id:
            self.id = id
        else:
            Base.__nb_objects += 1
    ...
    def from_json_string(json_string):
        """Returns Python objs of JSON string representation"""
    ...
    def create(cls, **dictionary):
        """Returns insatnce with attributes already set"""
